namespace Tests.Element
{
    ...
    public class ThunderTests
    {
        ...
        public void ThunderCanMixWithWater()
        {
            ...
            IElement mixedElement = water.GetMixedElement(thunder);
        ...
        public void ThunderMustStackWithWater()
        {
            ...
            Assert.IsTrue(tile.Element.Contains(thunder));
            Assert.IsTrue(tile.Element.Contains(water));
        }
